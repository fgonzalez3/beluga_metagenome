...
rule align_reads_to_contigs_spades: # test
    """
    Align raw reads back to assembled contigs to assess coverage, assembly quality, and obtain BAM files for binning from SPAdes assemblies.
...
rule align_reads_to_contigs_megahit: # test
    """
    Align raw reads back to assembled contigs to assess coverage, assembly quality, and obtain BAM files for binning from megahit assemblies.
    BAM files will consist of read alignments to individual sample assemblies and co-assemblies. 
    """
    input:
        # 1. Individual metagenome assemblies
    ...
    output:
        ...
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_read_alignment_megahit/{sample}_aligned_sorted.bam",

        # 2. Per whale metagenome co-assemblies
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_per_whale_coassemblies/{sample}/{sample}_indexed_contig.1.bt2",
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_per_whale_coassemblies/{sample}/{sample}_indexed_contig.2.bt2",
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_per_whale_coassemblies/{sample}/{sample}_indexed_contig.3.bt2",
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_per_whale_coassemblies/{sample}/{sample}_indexed_contig.4.bt2",
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_per_whale_coassemblies/{sample}/{sample}_indexed_contig.rev.1.bt2",
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_per_whale_coassemblies/{sample}/{sample}_indexed_contig.rev.2.bt2",
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_per_whale_coassemblies/{sample}_aligned_sorted.bam",

        # 3. Master co-assembly
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_master_coassemblies/{sample}/{sample}_indexed_contig.1.bt2",
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_master_coassemblies/{sample}/{sample}_indexed_contig.2.bt2",
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_master_coassemblies/{sample}/{sample}_indexed_contig.3.bt2",
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_master_coassemblies/{sample}/{sample}_indexed_contig.4.bt2",
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_master_coassemblies/{sample}/{sample}_indexed_contig.rev.1.bt2",
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_master_coassemblies/{sample}/{sample}_indexed_contig.rev.2.bt2",
        "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_master_coassemblies/{sample}_aligned_sorted.bam"
    params:
        genera=config["genera"],
        outdir1 = "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_individual_assemblies/{sample}",
        outdir2 = "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_per_whale_coassemblies/{sample}",
        outdir3 = "results/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_master_coassemblies/{sample}"
        log:
        stdout1 = "logs/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_individual_assemblies/{sample}_aln.out",
        stderr1 = "logs/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_individual_assemblies/{sample}_aln.err",

        stdout2 = "logs/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_per_whale_coassemblies/{sample}_aln.out",
        stderr2 = "logs/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_per_whale_coassemblies/{sample}_aln.err",

        stdout3 = "logs/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_master_coassemblies/{sample}_aln.out",
        stderr3 = "logs/{genera}/2_assembly/align_reads_to_contigs/contig_index_megahit_master_coassemblies/{sample}_aln.err"
    shell:
        """
        module unload miniconda 
        module load Bowtie2/2.5.1-GCC-12.2.0
