...
rule all:
    input:
        ...
        # 6. Binning
        expand("results/{genera}/6_binning/concoct/SPAdes_individual_assembly/{sample}/CONCOCT.*.fa", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/concoct/SPAdes_individual_assembly/{sample}/concoct_output/clustering_merged.csv", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/concoct/megahit_individual_assembly/{sample}/CONCOCT.*.fa", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/concoct/megahit_individual_assembly/{sample}/concoct_output/clustering_merged.csv", sample=SAMPLES, genera=config["genera"]),
        ...
        expand("results/{genera}/6_binning/metabat/SPAdes_individual_assembly/{sample}/METABAT.*.fa", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/metabat/megahit_individual_assembly/{sample}/METABAT.txt", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/metabat/megahit_individual_assembly/{sample}/METABAT.*.fa", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/maxbin/SPAdes_individual_assembly/maxbin.txt", genera=config["genera"]),
        expand("results/{genera}/6_binning/maxbin/megahit_individual_assembly/maxbin.txt", genera=config["genera"]),
        expand("results/{genera}/6_binning/maxbin/SPAdes_individual_assembly/{sample}/MAXBIN.*.fa", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/maxbin/SPAdes_individual_assembly/{sample}/MAXBIN.summary", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/maxbin/megahit_individual_assembly/{sample}/MAXBIN.*.fa", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/maxbin/megahit_individual_assembly/{sample}/MAXBIN.summary", sample=SAMPLES, genera=config["genera"]),
        ...
        expand("results/{genera}/6_binning/semibin2/megahit_individual_assembly/generate_concatenated_db/concatenated.fa", genera=config["genera"]),
        ...
        expand("results/{genera}/6_binning/semibin2/megahit_individual_assembly/align_to_concatenated_db/{sample}/{sample}_indexed_contig.1.bt2", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/semibin2/megahit_individual_assembly/align_to_concatenated_db/{sample}/{sample}_indexed_contig.2.bt2", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/semibin2/megahit_individual_assembly/align_to_concatenated_db/{sample}/{sample}_indexed_contig.3.bt2", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/semibin2/megahit_individual_assembly/align_to_concatenated_db/{sample}/{sample}_indexed_contig.4.bt2", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/semibin2/megahit_individual_assembly/align_to_concatenated_db/{sample}/{sample}_indexed_contig.rev.1.bt2", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/semibin2/megahit_individual_assembly/align_to_concatenated_db/{sample}/{sample}_indexed_contig.rev.2.bt2", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/semibin2/megahit_individual_assembly/align_to_concatenated_db/{sample}_aligned_sorted.bam", sample=SAMPLES, genera=config["genera"]),
        ...
        expand("results/{genera}/6_binning/semibin2/megahit_individual_assembly/features_and_model/{sample}/data_split.csv", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/semibin2/megahit_individual_assembly/features_and_model/{sample}/data.csv", sample=SAMPLES, genera=config["genera"]),
        ...
        expand("results/{genera}/6_binning/semibin2/megahit_individual_assembly/train_model/{sample}/model.pt", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/SPAdes_individual_assembly/semibin2/bin/{sample}/bin.*.fa", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/megahit_individual_assembly/semibin2/bin/{sample}/bin.*.fa", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/SPAdes_individual_assembly/aggregate_bins/{sample}/metabat_associations.tsv", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/SPAdes_individual_assembly/aggregate_bins/{sample}/maxbin_associations.tsv", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/SPAdes_individual_assembly/aggregate_bins/{sample}/concoct_associations.tsv", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/SPAdes_individual_assembly/aggregate_bins/{sample}/semibin_associations.tsv", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/SPAdes_individual_assembly/aggregate_bins/{sample}/DASTOOL.*.fa", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/megahit_individual_assembly/aggregate_bins/{sample}/metabat_associations.tsv", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/megahit_individual_assembly/aggregate_bins/{sample}/maxbin_associations.tsv", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/megahit_individual_assembly/aggregate_bins/{sample}/concoct_associations.tsv", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/megahit_individual_assembly/aggregate_bins/{sample}/semibin_associations.tsv", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/megahit_individual_assembly/aggregate_bins/{sample}/DASTOOL.*.fa", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/SPAdes_individual_assembly/binning_qc/{sample}/quality_report.tsv", sample=SAMPLES, genera=config["genera"]),
        expand("results/{genera}/6_binning/megahit_individual_assembly/binning_qc/{sample}/quality_report.tsv", sample=SAMPLES, genera=config["genera"])
