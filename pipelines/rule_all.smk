...
def evaluate_individual_assemblies():
    ...
    for assembler in config["assembler"]:
        for sample in SAMPLES:
            if assembler == "spades":
                outputs.append(f"results/{config["genera"]}/testing/5_evaluate_assemblies/spades/filter_individual_assemblies/{sample}/assembly_DEDUP95_m1500.fasta"),
                outputs.append(f"results/{config["genera"]}/testing/5_evaluate_assemblies/QUAST/report.html")
            elif assembler == "megahit":
                outputs.append(f"results/{config["genera"]}/testing/5_evaluate_assemblies/megahit/filter_individual_assemblies/{sample}/assembly_DEDUP95_m1500.fasta"),
                outputs.append(f"results/{config["genera"]}/testing/5_evaluate_assemblies/QUAST/report.html")
    return outputs
    ...
    for assembler in config["assembler"]:
        for sample in SAMPLES:
            if assembler == "spades":
                ...
                # Concoct Outputs
                outputs.append(f"results/{config["genera"]}/testing/6_binning/concoct/spades_individual_assembly/{sample}/contigs_20k.fa"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/concoct/spades_individual_assembly/{sample}/contigs_20k.bed"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/concoct/spades_individual_assembly/{sample}/coverage_table.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/concoct/spades_individual_assembly/{sample}/bins/clustering.csv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/concoct/spades_individual_assembly/{sample}/bins/clustering_merged.csv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/concoct/spades_individual_assembly/{sample}/fasta_bins/manifest.txt"),

                # Metabat Outputs
                outputs.append(f"results/{config["genera"]}/testing/6_binning/metabat/spades_individual_assembly/{sample}/METABAT.txt"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/metabat/spades_individual_assembly/{sample}/bins/check.txt"),

                # MaxBin Outputs
                outputs.append(f"results/{config["genera"]}/testing/6_binning/maxbin/spades_individual_assembly/{sample}/maxbin.txt"),
                ...
                outputs.append(f"results/{config["genera"]}/testing/6_binning/DASTool/spades_individual_assembly/contigs2bin/{sample}.concoct.contigs2bin.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/DASTool/spades_individual_assembly/contigs2bin/{sample}.maxbin.contigs2bin.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/DASTool/spades_individual_assembly/contigs2bin/{sample}.metabat.contigs2bin.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/DASTool/spades_individual_assembly/refined_bins/{sample}/check.tsv"),

                # MetaWRAP Outputs
                #outputs.append(f"results/{config["genera"]}/testing/6_binning/MetaWRAP/spades_individual_assembly/{sample}/bin_refinement/Binning_refiner.stats"),

                # CheckM Outputs
                outputs.append(f"results/{config["genera"]}/testing/6_binning/CheckM/spades_individual_assembly/{sample}/lineage.ms"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/CheckM/spades_individual_assembly/{sample}/lineage_results.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/CheckM/spades_individual_assembly/{sample}/qa_results.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/CheckM2/spades_individual_assembly/{sample}/quality_report.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/GUNC/spades_individual_assembly/{sample}/check.txt")

            elif assembler == "megahit":
                # Concoct Outputs
                outputs.append(f"results/{config["genera"]}/testing/6_binning/concoct/megahit_individual_assembly/{sample}/contigs_20k.fa"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/concoct/megahit_individual_assembly/{sample}/contigs_20k.bed"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/concoct/megahit_individual_assembly/{sample}/coverage_table.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/concoct/megahit_individual_assembly/{sample}/bins/clustering.csv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/concoct/megahit_individual_assembly/{sample}/bins/clustering_merged.csv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/concoct/megahit_individual_assembly/{sample}/fasta_bins/manifest.txt"),

                # Metabat Outputs
                outputs.append(f"results/{config["genera"]}/testing/6_binning/metabat/megahit_individual_assembly/{sample}/METABAT.txt"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/metabat/megahit_individual_assembly/{sample}/bins/check.txt"),

                # MaxBin Outputs
                outputs.append(f"results/{config["genera"]}/testing/6_binning/maxbin/megahit_individual_assembly/{sample}/maxbin.txt"),
                ...
                outputs.append(f"results/{config["genera"]}/testing/6_binning/DASTool/megahit_individual_assembly/contigs2bin/{sample}.concoct.contigs2bin.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/DASTool/megahit_individual_assembly/contigs2bin/{sample}.maxbin.contigs2bin.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/DASTool/megahit_individual_assembly/contigs2bin/{sample}.metabat.contigs2bin.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/DASTool/megahit_individual_assembly/refined_bins/{sample}/check.tsv"),

                # MetaWRAP Outputs
                #outputs.append(f"results/{config["genera"]}/testing/6_binning/MetaWRAP/megahit_individual_assembly/{sample}/bin_refinement/Binning_refiner.stats"),

                # CheckM Outputs
                outputs.append(f"results/{config["genera"]}/testing/6_binning/CheckM/megahit_individual_assembly/{sample}/lineage.ms"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/CheckM/megahit_individual_assembly/{sample}/lineage_results.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/CheckM/megahit_individual_assembly/{sample}/qa_results.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/CheckM2/megahit_individual_assembly/{sample}/quality_report.tsv"),
                outputs.append(f"results/{config["genera"]}/testing/6_binning/GUNC/megahit_individual_assembly/{sample}/check.txt")
    return outputs
